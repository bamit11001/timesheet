      ...
      <div class="row main_row">
              ...
              <div class="form-group">
                ...
                <div class="form-check">
                  <label class="form-check-label">
                    <input type="checkbox" class="form-check-input @error('agree') is-invalid @enderror" name="terms" value="true" {{ !old('terms') ?: 'checked' }}>{{ __('By joining I agree with ') }} <a href="#">Private Policy</a>
        ...
        <div class="col-md-6">
          <div class="text-center right-block">
            ...
            <p class="my-3">Already have an account ? <a href="company_signin.html" style="color:#f60;">Sign In</a></p>
          </div>
        </div>
      </div>
    </div>
