...
<section class="compny_signup">
  <div class="container">
    <div class="row main_row">
      ...
      <div class="col-md-6">
        <div class="user-form">     
          <h4 class="my-4">Hello! Welcome Back1</h4>
        <form class="employer-login-form" method="post" action="{{ route('employer.login.submit') }}">
          <div class="form-group">
            ...
            <div class="form-group form-check d-flex justify-content-between">
              ...
              <a href="{{ route('password.request') }}" class="font-weight-bold text-decoration-none outline" data-toggle="modal" style="color:#fb4907; font-size: 14px;">Forgot Password ?</a>
              @endif                    
            </div>
          </div>
          <div class="text-center">
            ...
            <p class="my-3">Not a member? <a href="company_signup.html" style="color:#f60;">Sign Up</a></p>
          </div>
        </form>
        </div>
        </div>
