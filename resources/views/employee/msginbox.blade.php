...
@section('content')   
<section class="content msg-inbox msg-chtbox">
    <div class="container">
        <div class="card">
            <div class="headers">                    
                <h2>Message Box</h2>
                            ...
                            <div class="left-side">
                                ...
                                <div class="tabs">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li href="#home"  onclick="enableTxt({{ $message->company_id }})" id="user_{{ $message->user->id }}" class="active" data-toggle="tab">

                                                <!-- <a href="#home" data-toggle="tab"> -->
                                                <div class="box">
                                                    <input type="hidden" name="id" value="{{ $message->company->id }}">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <p>{{ $message->company->nature_of_business }}</p>
                                                    </div>
                                                </div>
                                                <!-- <div class="box">
                                                    <input type="hidden" name="id" value="{{ $message->company->id }}">
                                                    <div class="img-box user-img">
                                                    @if($message->company->profile_img != '')
                                                        <img style="width:100%;" src="{{ url('') }}/images/employee/{{$message->user->profile_img }}" alt="image">
                                                    @else
                                                        <img src="{{asset('images')}}/ICON.png" alt="image">
                                                    @endif    
                            ...
                            <div class="right-side">
                                <div class="bodyy" id="message-box">
                                    <div class="tab-content">
                                        <div id="home" class="main-inbox">
                                        </div>
                                        <div id="home" class="tab-pane active main-inbox">
                                        </div>
                                    </div>
                                </div>
                                <div class="footer send-message snd-msg">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <div class="upload-rsm rms">                                          
                                                <!-- <input type="file" id="file" accept="application/pdf, image/*, .doc, .docx" name="file"> -->
                                                <p class="position-relative file-infomsg">               
                                                    <a href="javascript:void(0)">							
                                                        <i class="fa fa-paperclip"></i>
                                                        <input type="file" id ="file" style="position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:&quot;progid:DXImageTransform.Microsoft.Alpha(Opacity=0)&quot;;opacity:0;background-color:transparent;color:transparent; cursor: pointer;" name="file_source" size="10" onchange="$(&quot;#upload-file-info&quot;).html($(this).val());">
                                                    </a>
                                            ...
                                            <!-- <input type="file" id="file" accept="application/pdf, image/*, .doc, .docx" name="file"> -->
                                            <!-- </div> -->
                                            <button type="button" onclick="sendmsg(this)" class="btn btn-primary send-btn" sty >SEND</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    function enableTxt(company_id) 
    {
        
        $(".footer").removeClass("send-message");
        
        // var company_id = $(elem).attr("company-id");

        $.ajax({
            type:'POST',
            url:"{{ route('employee.inbox.message') }}",
...
setInterval(function()
    ...
    function sendmsg(elem) 
    {
        ...
        formData.append('_token', '{{csrf_token()}}'); 
            ...
            $.ajax({
                type:'POST',
                url:"{{ route('employee.send.message') }}",
                data:formData,
                processData: false,
                contentType: false,
                success:function(data){
